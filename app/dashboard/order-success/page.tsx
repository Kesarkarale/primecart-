...
export default function OrderSuccessPage() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (savedOrders) {
        try {
          ...
          if (Array.isArray(parsedOrders)) {
            if (requestedOrderId) {
              selectedOrder =
                parsedOrders.find((item: Order) => {
                  const id = item?.id || item?.orderId;

                  return String(id) === String(requestedOrderId);
                }) || null;
            }

            /*
             * If URL order ID is not found,
             * use latest order.
             */
            if (!selectedOrder && parsedOrders.length > 0) {
              selectedOrder =
                parsedOrders[parsedOrders.length - 1];
            }
          }
        } catch (error) {
          console.error(
            "Unable to parse primecart-orders:",
            error
          );
        }
      }
      ...
      /*
       * Fallback to primecart-last-order
       */
      if (!selectedOrder && lastOrder) {
        try {
          selectedOrder = JSON.parse(lastOrder);
        } catch (error) {
          console.error(
            "Unable to parse primecart-last-order:",
            error
          );
        }
      }
  ...
  const discount = Number(
    order?.discount || order?.savings || 0
  );
  ...
  const paymentMethod = getPaymentName(
    order?.paymentMethod
  );
    ...
    return (
      <main className="flex min-h-screen items-center justify-center bg-[#fffdf9]">
        <div className="flex flex-col items-center">
          <div className="h-12 w-12 animate-spin rounded-full border-4 border-[#eadfc8] border-t-[#b8872d]" />

          <p className="mt-4 text-sm font-semibold text-[#766b5b]">
            Loading your order...
          </p>
        </div>
      </main>
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#fffdf9] text-[#2d261d]">
        {/* Decorative background */}
        <div className="pointer-events-none fixed inset-0 overflow-hidden">
          <div className="absolute -left-40 -top-40 h-96 w-96 rounded-full bg-[#f3e4c1]/40 blur-3xl" />

          <div className="absolute -right-40 top-40 h-96 w-96 rounded-full bg-[#f5ead2]/40 blur-3xl" />

          <div className="absolute bottom-0 left-1/3 h-80 w-80 rounded-full bg-[#faf0dc]/50 blur-3xl" />
        </div>
        ...
        <header className="relative z-10 border-b border-[#eadfca] bg-white/90 backdrop-blur-xl">
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
          ...
          <section className="text-center">
            ...
            <div className="relative mx-auto mb-6 h-24 w-24">
              ...
              <div className="relative flex h-24 w-24 items-center justify-center rounded-full border border-[#dec27f] bg-gradient-to-br from-[#fffaf0] to-[#f4e3b7] shadow-[0_18px_50px_rgba(184,135,45,0.18)]">
                <CheckCircle2
                  className="h-14 w-14 text-[#b8872d]"
                  strokeWidth={1.8}
                />
              </div>
            </div>
            ...
            <p className="mx-auto mt-4 max-w-2xl text-sm leading-6 text-[#766b5b] sm:text-base">
              ...
              We&apos;ll keep you updated as your package
              moves towards you.
            </p>
            ...
            <div className="mx-auto mt-6 flex w-fit max-w-full items-center gap-2 rounded-2xl border border-[#e7d9bc] bg-white px-4 py-3 shadow-sm">
              <div className="min-w-0">
                ...
                <p className="mt-1 truncate text-sm font-black text-[#3b3022] sm:text-base">
                  {orderId}
                </p>
              </div>
          ...
          <section className="mt-10 rounded-3xl border border-[#e9dec8] bg-white p-5 shadow-[0_12px_45px_rgba(70,50,20,0.06)] sm:p-7">
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <div className="relative text-center">
                ...
                <div className="relative mx-auto flex h-12 w-12 items-center justify-center rounded-full border border-[#c79a3b] bg-[#f8edcf] text-[#b8872d]">
                  <CheckCircle2 className="h-5 w-5" />
                </div>

                <p className="mt-3 text-xs font-bold text-[#7f5d24] sm:text-sm">
                  Confirmed
                </p>
              </div>
              ...
              <div className="relative text-center">
                ...
                <div className="relative mx-auto flex h-12 w-12 items-center justify-center rounded-full border border-[#e5dccb] bg-[#faf9f6] text-[#b9ae9d]">
                  <Package className="h-5 w-5" />
                </div>

                <p className="mt-3 text-xs font-bold text-[#958875] sm:text-sm">
                  Packed
                </p>
              </div>
              ...
              <div className="text-center">
                <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full border border-[#e5dccb] bg-[#faf9f6] text-[#b9ae9d]">
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <div className="mt-2 flex flex-wrap gap-x-4 gap-y-1 text-xs text-[#8b7d68]">
                              <span>
                                Qty:{" "}
              ...
              <section className="rounded-3xl border border-[#e9dec8] bg-white p-5 shadow-[0_12px_45px_rgba(70,50,20,0.06)] sm:p-7">
                ...
                {address ? (
                  ...
                  <div className="rounded-2xl border border-dashed border-[#dfd3bb] bg-[#fcfaf5] p-5 text-sm text-[#83745e]">
                    Delivery address information is not
                    available.
                  </div>
                )}
              </section>
            ...
            <div className="space-y-6">
              ...
              <section className="rounded-3xl border border-[#dfdecf] bg-white p-5 shadow-[0_12px_45px_rgba(70,50,20,0.07)] sm:p-6">
                ...
                <div className="mt-5 space-y-3 text-sm">
                  <div className="flex justify-between text-[#756754]">
                    <span>Subtotal</span>
                  ...
                  <div className="flex justify-between text-[#756754]">
                    ...
                    <span
                      className={
                        delivery === 0
                          ? "font-bold text-[#4b8a62]"
                          : "font-semibold text-[#4d402f]"
                      }
                    >
                      {delivery === 0
                        ? "FREE"
                  ...
                  {discount > 0 && (
                    <div className="flex justify-between text-[#4b8a62]">
                      <span>Discount</span>
              ...
              <section className="rounded-3xl border border-[#e9dec8] bg-[#fffaf0] p-5 sm:p-6">
                ...
                <p className="mt-2 text-xs leading-5 text-[#82745f]">
                  ...
                  order as it moves through each delivery
                  stage.
                </p>
              </section>
            </div>
          ...
          <section className="mt-8 flex flex-col-reverse gap-3 sm:flex-row sm:justify-center">
            <button
              type="button"
              onClick={printOrder}
              className="inline-flex h-12 items-center justify-center gap-2 rounded-xl border border-[#ded2bd] bg-white px-5 text-sm font-bold text-[#665642] shadow-sm transition hover:border-[#c79a3b] hover:text-[#a57521]"
            >
            ...
            <button
              ...
              className="inline-flex h-12 items-center justify-center gap-2 rounded-xl border border-[#d9c8a7] bg-white px-5 text-sm font-bold text-[#665642] shadow-sm transition hover:border-[#c79a3b] hover:text-[#a57521]"
            >
            ...
            <button
              type="button"
              onClick={() => router.push("/dashboard")}
              className="inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-[#b8872d] px-6 text-sm font-black text-white shadow-[0_10px_25px_rgba(184,135,45,0.24)] transition hover:bg-[#a57521]"
            >
              Continue Shopping
          ...
          {/* Footer */}
          <div className="mt-10 flex items-center justify-center gap-2 text-center text-xs text-[#998c78]">
